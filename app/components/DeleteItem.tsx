...
const trashIcon = (
    <svg className="trash-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 24 24">
...
export default function DeleteItem({ itemId, userId }: props) {
    ...
    return (
        <button onClick={deleteItem} className="remove-item-btn">{trashIcon}</button>
    );
}